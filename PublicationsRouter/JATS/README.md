...
| metadata.author.affiliations.identifier | `…<aff><institution-wrap><institution-id institution-id-type="…">` | The identifier object is created from `<institution-id>` element. |
...
| metadata.author.affiliations.dept | `…<aff><institution content-type="*">` <br>or<br> `…<aff><institution-wrap><institution content-type="*">` <br>* - where `content-type` contains one of: "dept", "department", "division", "office" (E.g. `content-type="org-division"` or `content-type="office"`)| |
