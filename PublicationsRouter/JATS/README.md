...
| metadata.author.affiliations.dept | `…<aff><institution content-type="…">` <br>or<br> `…<aff><institution-wrap><institution content-type="…">` | For an `<institution …>` element to be recognised as a `dept` field its `content-type` must contain one of: <ul><li>`dept`</li><li>`department`</li><li>`division`</li><li>`office`</li></ul>.<br>Examples:<br> `content-type="org-division"` <br>or `content-type="office"` |
...
| metadata.contributor.affiliations.dept | `…<aff><institution content-type="…">` <br>or<br> `…<aff><institution-wrap><institution content-type="…">` | For an `<institution …>` element to be recognised as a `dept` field its `content-type` must contain one of: <ul><li>`dept`</li><li>`department`</li><li>`division`</li><li>`office`</li></ul>.<br>Examples:<br> `content-type="org-division"` <br>or `content-type="office"` |
