...
| [dc:coverage](http://www.rioxx.net/schema/v2.0/rioxx/terms_.html#http___purl.org_dc_terms__coverage) | N/A | Not supported by Router
...
| [dc:format](http://www.rioxx.net/schema/v2.0/rioxx/terms_.html#http___purl.org_dc_terms__format) | N/A | Not supported by router
...
| [dc:relation](http://www.rioxx.net/schema/v2.0/rioxx/terms_.html#http___purl.org_dc_terms__relation) | N/A | Not supported by Router
...
| [rioxxterms:apc](http://www.rioxx.net/schema/v2.0/rioxxterms/rioxxterms_.html#apc) | N/A | Not supported by Router
...
| [rioxxterms:version](http://www.rioxx.net/schema/v2.0/rioxxterms/rioxxterms_.html#version)  <br>{0..1} *<br><p style="font-size:smaller">NOTE: Possible versions - [AO, SMUR, AM, P, VoR, CVoR, EVoR, NA] | article.version | `<rioxxterms:version>[article.version] </rioxxterms:version>` |
[rioxxterms:version_of_record](http://www.rioxx.net/schema/v2.0/rioxxterms/rioxxterms_.html#version-of-record)  <br>{1..1}<br> <p style="font-size:smaller">Note: The DOI is formatted as a HTTP URI.  | article.identifier.id (DOI) | `<rioxxterms:version_of_record>Version: [article.identifier.id] </rioxxterms:version_of_record>` |
